...
UC-00 được trình bày thành 3 phần riêng: đăng ký, đăng nhập và quản lý hồ sơ. Mỗi phần có Use Case note (BASIC/ALTERNATE) tương ứng với sơ đồ đã tách.

| Use Case: UC-00a – Đăng ký tài khoản |
|---|
| **BASIC COURSE**<br>1. Khách hàng chọn chức năng Đăng ký.<br>2. Hệ thống hiển thị form và yêu cầu nhập email/số điện thoại + mật khẩu.<br>3. Hệ thống kiểm tra trùng email/số điện thoại.<br>4. Nếu hợp lệ, hệ thống tạo tài khoản và khởi tạo hồ sơ ban đầu.<br>5. Hệ thống thông báo đăng ký thành công.<br><br>**ALTERNATE COURSE**<br>- Trùng email/số điện thoại: hệ thống thông báo lỗi và yêu cầu nhập lại. |
...
| Use Case: UC-00b – Đăng nhập |
|---|
| **BASIC COURSE**<br>1. Khách hàng chọn chức năng Đăng nhập.<br>2. Hệ thống hiển thị form và yêu cầu nhập email/số điện thoại + mật khẩu.<br>3. Hệ thống đối chiếu thông tin và tạo phiên đăng nhập.<br>4. Hệ thống thông báo đăng nhập thành công.<br><br>**ALTERNATE COURSE**<br>- Sai thông tin đăng nhập: hệ thống thông báo lỗi và yêu cầu nhập lại. |
...
| Use Case: UC-00c – Quản lý hồ sơ |
|---|
| **BASIC COURSE**<br>1. Khách hàng mở màn hình hồ sơ và nhập thông tin cần cập nhật.<br>2. Hệ thống kiểm tra hợp lệ dữ liệu hồ sơ/bảo hiểm (nếu có).<br>3. Hệ thống lưu thông tin hồ sơ (và bảo hiểm nếu có).<br>4. Hệ thống thông báo cập nhật thành công.<br><br>**ALTERNATE COURSE**<br>- Dữ liệu không hợp lệ: hệ thống thông báo lỗi và yêu cầu chỉnh sửa. |
...
UC-01 được tách thành 2 phần riêng để trình bày gọn: (a) tìm kiếm và hiển thị danh sách; (b) xem chi tiết và tải slot.

| Use Case: UC-01a – Tìm kiếm & hiển thị danh sách |
|---|
| **BASIC COURSE**<br>1. Khách hàng nhập tiêu chí tìm kiếm.<br>2. Hệ thống truy vấn catalog và hiển thị danh sách kết quả.<br><br>**ALTERNATE COURSE**<br>- Không có kết quả: hệ thống thông báo và hiển thị trạng thái “không có kết quả”. |
...
| Use Case: UC-01b – Xem chi tiết & tải slot |
|---|
| **BASIC COURSE**<br>1. Khách hàng chọn 1 mục từ danh sách kết quả.<br>2. Hệ thống điều hướng sang trang chi tiết.<br>3. Hệ thống tải dữ liệu chi tiết và danh sách slot còn trống.<br>4. Hệ thống hiển thị trang chi tiết và slot.<br><br>**ALTERNATE COURSE**<br>- Slot vừa hết: hệ thống cảnh báo và UI cập nhật lại. |
...
Để trình bày gọn theo từng chức năng, mục này được tách thành 2 phần (Use Case note riêng) tương ứng 2 sơ đồ: UC-05 (hủy lịch) và UC-06 (hoàn tiền).

| Use Case: UC-05 – Hủy lịch |
|---|
| **BASIC COURSE**<br>1. Khách hàng yêu cầu hủy đơn.<br>2. Hệ thống kiểm tra điều kiện/cut-off theo chính sách.<br>3. Nếu hợp lệ, hệ thống cập nhật trạng thái đơn là Cancelled.<br>4. Hệ thống thông báo kết quả hủy cho khách hàng.<br><br>**ALTERNATE COURSE**<br>- Quá cut-off/không hợp lệ: hệ thống từ chối hủy và thông báo lý do. |
...
| Use Case: UC-06 – Yêu cầu hoàn tiền |
|---|
| **BASIC COURSE**<br>1. Khách hàng yêu cầu hoàn tiền cho đơn đã thanh toán.<br>2. Hệ thống kiểm tra điều kiện hoàn theo chính sách.<br>3. Nếu đủ điều kiện, hệ thống gửi yêu cầu hoàn qua cổng thanh toán/gateway.<br>4. Hệ thống thông báo kết quả hoàn tiền cho khách hàng.<br><br>**ALTERNATE COURSE**<br>- Không đủ điều kiện: hệ thống từ chối và thông báo lý do.<br>- Gateway lỗi/tạm thời: hệ thống ghi nhận trạng thái chờ xử lý và retry. |
...
Để dễ theo dõi, mục này được tách thành 2 phần (Use Case note riêng) tương ứng 2 sơ đồ: UC-07 (gửi review) và UC-08 (kiểm duyệt review).

| Use Case: UC-07 – Gửi review |
|---|
| **BASIC COURSE**<br>1. Khách hàng nhập rating + nội dung review và gửi.<br>2. Hệ thống kiểm tra điều kiện và lưu review ở trạng thái Pending.<br>3. Hệ thống thông báo đã tiếp nhận review.<br><br>**ALTERNATE COURSE**<br>- Chưa đăng nhập: hệ thống yêu cầu đăng nhập.<br>- Nội dung không hợp lệ: hệ thống từ chối và thông báo lỗi.<br>- Cảnh báo spam (nếu phát hiện): hệ thống hiển thị cảnh báo. |
...
| Use Case: UC-08 – Kiểm duyệt review |
|---|
| **BASIC COURSE**<br>1. Nhân viên kiểm duyệt mở danh sách review chờ duyệt.<br>2. Nhân viên chọn 1 review và quyết định duyệt/từ chối.<br>3. Hệ thống cập nhật trạng thái review và ghi nhận log kiểm duyệt.<br>4. Hệ thống cập nhật lại danh sách hiển thị.<br><br>**ALTERNATE COURSE**<br>- Review không còn hợp lệ: hệ thống từ chối thao tác và thông báo. |
...
Để tránh quá tải, mục này được tách thành 2 phần (Use Case note riêng) tương ứng 2 sơ đồ: UC-10 (nhập catalog) và UC-11 (xuất mini-catalog XML).

| Use Case: UC-10 – Nhập catalog đối tác |
|---|
| **BASIC COURSE**<br>1. NV cơ sở y tế gửi dữ liệu catalog.<br>2. Hệ thống kiểm tra định dạng và hợp nhất vào catalog tổng.<br>3. Hệ thống ghi log kết quả nhập và thông báo trạng thái nhập.<br><br>**ALTERNATE COURSE**<br>- Sai định dạng/thiếu trường: hệ thống từ chối và thông báo lỗi.<br>- Cảnh báo trùng/không khớp ID (nếu phát hiện): hệ thống thông báo cảnh báo. |
...
| Use Case: UC-11 – Xuất mini-catalog XML |
|---|
| **BASIC COURSE**<br>1. Đối tác yêu cầu xuất mini-catalog XML.
<br>2. Hệ thống kiểm tra quyền truy cập.
<br>3. Hệ thống đọc catalog tổng theo phạm vi và sinh XML theo schema.
<br>4. Hệ thống ghi log và trả XML.
<br><br>**ALTERNATE COURSE**<br>- Thiếu dữ liệu: hệ thống trả XML rỗng hoặc thông báo lỗi theo quy ước. |
