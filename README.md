...
| WBS ID | Hạng mục | Deliverable chính |
|---|---|---|
| 1.1 | Lập kế hoạch tổng thể | Scope/FR-NFR + baseline |
| 1.2 | Theo dõi tiến độ/chi phí | Báo cáo tiến độ (giả định) |
| 1.3 | Quản lý thay đổi | Change log (giả định) |
| 2.1 | BOM + thiết kế nguồn/bơm | BOM + block diagram |
| 2.2 | Mua linh kiện | Danh sách mua hàng (giả định) |
| 2.3 | Prototype #1 | Prototype #1 hoạt động |
| 2.4 | Firmware đọc cảm biến | Telemetry basic |
| 2.5 | Firmware kết nối cloud | MQTT/HTTP + reconnect |
| 2.6 | Điều khiển bơm an toàn | Pump control stable |
| 2.7 | Prototype #2 + hiệu chuẩn | Prototype #2 ổn định |
| 2.8 | Test HW/FW | Kết quả test (tóm tắt) |
| 3.1 | Cloud architecture + contract | API/MQTT contract |
| 3.2 | Ingest telemetry | Ingest chạy demo |
| 3.3 | Storage + query | API lịch sử/latest |
| 3.4 | Command path | App→cloud→device command |
| 3.5 | Alert rules + notify | Cảnh báo (giả định) |
| 3.6 | Logging/monitoring | Log/checklist |
| 4.1 | UX flow + wireframe | Wireframe/mockup |
| 4.2 | Dashboard realtime | Màn dashboard |
| 4.3 | Lịch sử/biểu đồ | Màn lịch sử |
| 4.4 | Cảnh báo + ngưỡng | Màn cảnh báo |
| 4.5 | Điều khiển bơm | Màn điều khiển |
| 4.6 | Xử lý lỗi kết nối | Offline/error UI |
| 5.1 | Test plan + test cases | Test plan + sample cases |
| 5.2 | Integration test end-to-end | KQ test tích hợp |
| 5.3 | UAT + nghiệm thu | Biên bản UAT (tóm tắt) |
| 6.1 | Kế hoạch triển khai | Deployment checklist |
| 6.2 | Hỗ trợ sau bán | Support plan |
| 6.3 | Hoàn thiện báo cáo/slide | Báo cáo + slide |
